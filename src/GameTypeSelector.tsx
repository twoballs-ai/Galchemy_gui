...
const GameTypeSelector: React.FC<GameTypeSelectorProps> = ({ onSelect }) => {
  const gameTypes = [
    {
      key: '2d',
      title: '2D Игра (Canvas 2D)',
      description:
        'Игра с использованием Canvas 2D. Позволяет создавать простые игры с 2D-графикой, используя примитивы (квадраты, круги) и спрайты. Идеально подходит для нетребовательных игр и простых проектов.',
    },
    {
      key: 'webgl2d',
